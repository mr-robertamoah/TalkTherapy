...
| TT-3.2-follow-up-2 | Full-membership group video (SCRUM-314) — placeholder, not yet scoped. Follow-up to TT-3.2, extending video access from counsellors+creator to every GroupTherapyMembership member. | Story | — | — | New (placeholder) | TT-3.2 |
