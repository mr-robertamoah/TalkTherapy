...
| TT-7.3b-f2 (SCRUM-238) | Org-suspension enforcement: a `billing_suspended_at` (+ reason) column on `Organization` (mirrors `verified_at`'s single-current-state-flag precedent), single-writer from the invoice-settlement-failure path; enforced at the same TT-7.3b-f1 call site — a suspended org's retainer-covered members are blocked entirely (no personal-pay fallback) until the org settles. | Story | Medium | 5 | New split of TT-7.3b (SCRUM-230 review, 2026-09-03) | TT-7.3b-e, TT-7.3b-f1 |
