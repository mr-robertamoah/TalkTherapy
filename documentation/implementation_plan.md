...
| TT-7.3b-g (SCRUM-239) | Refund-reconciliation hook: callable-only mechanism (org admin notification + `CounsellorEarning`/ledger adjustment) for TT-7.7d to invoke later on an org-financed refund. No live UI trigger until TT-7.7 exists — independently testable via direct action invocation. This is what unblocks TT-7.7 per the existing resequencing. | Story | Medium | 5 | New split of TT-7.3b (SCRUM-230 review, 2026-09-03) | TT-7.3b-d |
