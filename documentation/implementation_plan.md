...
**Sprint:** 5 (TT-7.1 alongside TT-6). TT-7.4a/b/c/7 (all done) were fast-follows immediately
after TT-7.1 landed. TT-7.5 (now TT-7.5a, SCRUM-215) has outgrown fast-follow sizing at ~26
points provisional — same undersizing-on-first-pass pattern as TT-6.3/TT-2.2/TT-2.6/TT-7.2 — and
is tracked as its own mini-milestone (a1→a2→a3→{a4,a5}→a6) rather than a single-PR follow-up;
TT-7.5b (GroupTherapy) is unscheduled, blocked on TT-7.4d (itself unscoped). TT-7.6 (payout) and
TT-7.9 (multi-currency) are larger, separately-scheduled follow-ups — do not fold into Sprint 5's
commitment. TT-6.1
