...
| TT-7.3b-i (SCRUM-240) | Org payment-instrument onboarding UI: org-admin "add/replace payment method" screen, mirrors the TT-7.6a→TT-7.6d backend/frontend split precedent. | Story | Low | 5 | New split of TT-7.3b (SCRUM-230 review, 2026-09-03) | TT-7.3b-a |
