...
| TT-7.5b | GroupTherapy payment-gated access — TT-7.4d (per-member group-therapy payment) is now scoped (SCRUM-256/258-262, 2026-09-10), so this ticket's own scoping can proceed; will need GroupTherapy-equivalents of TT-7.5a's a2–a6 once TT-7.4d-a/b/d are live (needs real per-member payment status and a roster to reason about "who has paid" — implementation should wait even though scoping itself can start now). Uses the identical `payment_data` key name TT-7.5a establishes so TT-7.4d can reuse the shape rather than inventing a second one. Public/non-participant visibility unaffected, same as TT-7.5a. | Story | — | TBD | New split of TT-7.5 (SCRUM-215, product-owner/project-manager/architect review 2026-09-02) | TT-7.4d-a, TT-7.4d-b, TT-7.4d-d |
