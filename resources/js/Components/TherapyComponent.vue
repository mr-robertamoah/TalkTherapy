...
// per-scope consent check now lives entirely server-side (HasValidVideoConsentForSessionAction),
// and a minor without consent must still be able to click "join video" so they see the specific
