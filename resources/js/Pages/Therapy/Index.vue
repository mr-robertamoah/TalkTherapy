...
function listenToTherapy(currentTherapy) {
  Echo.join(`therapies.${currentTherapy.id}`)
    .here((users) => {
...
async function clickedResponse(response) {
  ...
  await axios
    ...
    .then((res) => {
      ...
      if (res.data.request?.status == "ACCEPTED") counsellor.value = res.data.request.to;
          ...
          >
            <div class="bg-white p-6 shrink-0 w-full" id="therapy_background_story">
              ...
              <div
                ...
                :class="[
                  computedTherapy.backgroundStory
            ...
            <div class="w-full shrink-0" id="therapy_participants">
              ...
              <div
                v-if="computedIsUser && !computedTherapy.counsellor"
              ...
              >
                ...
                >
                  ...
                  <div v-else class="h-10 flex justify-center items-center w-full">
                    no links for counsellor as at now.
                  </div>
                </div>
