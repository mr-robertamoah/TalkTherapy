...
- Before writing or reviewing any Vue/Tailwind UI, use the `frontend-design` skill
  (`.claude/skills/frontend-design/`) — it catches decorative glassmorphism/blur and other
  generic-AI-template tells this app has drifted into before.
